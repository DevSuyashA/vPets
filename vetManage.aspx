<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="vetManage.aspx.cs"
    Inherits="vPets_Services.adminauthormanagement" %>
                ...
                <div class="col-md-7">
                    ...
                    <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server"
                            AutoGenerateColumns="False" DataKeyNames="vID" DataSourceID="SqlDataSource1">
                            <Columns>
                                <asp:BoundField DataField="v_username" HeaderText="v_username"
                                    SortExpression="v_username" />
                                <asp:BoundField DataField="Password" HeaderText="Password" SortExpression="Password" />
                                <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
                                <asp:BoundField DataField="Address" HeaderText="Address" SortExpression="Address" />
                                <asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Email" />
                                <asp:BoundField DataField="Mobno" HeaderText="Mobno" SortExpression="Mobno" />
                                <asp:BoundField DataField="Open_time" HeaderText="Open_time"
                                    SortExpression="Open_time" />
                                <asp:BoundField DataField="Close_time" HeaderText="Close_time"
                                    SortExpression="Close_time" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                            ...
                            SelectCommand="SELECT * FROM [Veterinary] WHERE [vID]!=0"></asp:SqlDataSource>
                    </div>
                </div>
            </div>
        </div>
