<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Library_Management_New.WebForm1" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="TextBox7" ValidationExpression="[0-9]{6}" ErrorMessage="Pin Code Should be of 6 Digits!"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                                <div class="col-md-12">
