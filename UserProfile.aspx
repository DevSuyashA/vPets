<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="Library_Management_New.UserProfile" %>
            ...
            <div class="card"> 
                <div class="card-body"> 
                     ...
                     <div class="col">
                        <center>
                           <h4>Your Profile</h4>
                            ...
                            <asp:Label class="badge badge-pill badge-info" ID="Lable1" runat="server" Text="Your status"></asp:Label>
                    ...
                    <div class="row">
                     <div class="col">
                       <center>
                        <span class="badges badge-pill badge-info">Login Credentials</span>
                         </center>
               ...
               <div class="card"> 
                <div class="card-body"> 
                    ...
                    <div class="row">
                     <div class="col">
                        <center>
                           <h4>Your issued books </h4>       
                            <asp:Label class="badge badge-pill badge-info" ID="Label1" runat="server" Text="Yours books info"></asp:Label>
                        </center>
                     </div>
                  </div>
                     <div class="row">
                     ...
                     <div class="row">
                     <div class="col">
                        <asp:GridView class="table table-striped table bodered" ID="GridView1" runat="server"></asp:GridView>
                  </div>
                 </div>
                </div>
               </div>
