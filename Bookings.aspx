<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Bookings.aspx.cs" Inherits="Library_Management_New.AdminBookInventory" %>
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="BOOK ID"></asp:TextBox>
                               <asp:Button ID="Button4" runat="server" Text="Button" OnClick="Button4_Click" CssClass="btn btn-primary" /><i class="fas fa-check-circle" onclick="Button4_Click"></i>
                              <%--<asp:LinkButton class="btn btn-primary" ID="LinkButton4" runat="server"><i class="fas fa-check-circle" onclick="Button4_Click"></i></asp:LinkButton>--%>
 </div>
                        </div>
                     </div>
                     <div class="col-md-9">
...
runat="server" placeholder="Book Cost(per unit)" TextMode="Number" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
                  ...
                  <div class="row">
                     ...
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn btn-lg btn-block btn-warning" runat="server" Text="Update" OnClick="Button2_Click" />
                     </div>
                     <div class="col-4">
